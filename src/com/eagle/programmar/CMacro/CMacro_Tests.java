...
public class CMacro_Tests extends TestCase
{
	...
	{
		String[] define = new String[] {
				DEFINE + "(1 + 2 + 3 \\", "   4 +/*COMMENT*/5 + 6 \\", "7 + 8 + 9)"
		};
		check(define, "(1 + 2 + 3 \n   4 +/*COMMENT*/5 + 6 \n7 + 8 + 9)");
	}
	...
	{
		String[] define = new String[] {
				DEFINE + "    'u'     /* less than means the cell has a", "             * value */"
		};
		check(define, "'u'");
	}
	...
	{
		String val = "XpmCreatePixmapFromData, int, (Display * display," + "        Drawable d,"
