...
public class Natural_FindStatement extends TokenSequence
{
	...
	public static class Natural_FindType extends TokenChooser
	{
		...
		{
			public @S(10) Natural_KeywordChoice howMany = new Natural_KeywordChoice("FIRST", "NUMBER", "UNIQUE");
			public @S(20) @OPT Natural_Find_Number_Records numberRecords;
			public @S(30) Natural_Identifier_Reference viewName;
			public @S(40) @OPT Natural_KeywordChoice device = new Natural_KeywordChoice("PHYSICAL", "LOGICAL");
		...
		public @CHOICE static class Natural_FindWithBlock extends TokenSequence
		{
			...
			public @S(30) @OPT Natural_KeywordChoice device = new Natural_KeywordChoice("PHYSICAL", "LOGICAL");
	...
	{
		public @S(10) Natural_KeywordChoice andOr = new Natural_KeywordChoice("AND", "OR");
	...
	{
		public @S(10) Natural_KeywordChoice byWith = new Natural_KeywordChoice("BY", "WITH");
