...
import com.eagle.programmar.TCL.Expressions.TCL_BitwiseExpression;
import com.eagle.programmar.TCL.Expressions.TCL_BitwiseNotExpression;
...
import com.eagle.programmar.TCL.Terminals.TCL_HexNumber;
...
public class TCL_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(10) TCL_HexNumber hex;
	public @P(20) TCL_Number number;
	public @P(30) TCL_Literal literal;

	///////////////////////////////////////////////
	// Primary expressions

	public @P(100) TCL_SignedExpression signedExpression;
	public @P(110) TCL_BitwiseNotExpression notExpression;
	public @P(120) TCL_LogicalNotExpression bangExpression;
	public @P(130) TCL_BuiltIns builtIn;
	public @P(140) TCL_VariableExpression variableExpression;
	public @P(150) TCL_ParenthesizedExpression parenthesizedExpression;
	public @P(160) TCL_ArrayExpression arrayExpression;
	public @P(170) TCL_BracketExpr exprExpression;
	public @P(180) TCL_BracketLindex lindexExpression;
	public @P(190) TCL_BracketStringFirst stringFirstExpression;
	public @P(200) TCL_BracketStringLength stringLengthExpression;
	public @P(210) TCL_BracketStringCat stringCatExpression;
	public @P(220) TCL_BracketFunction functionCall;
	...
	public @P(1030) TCL_BitwiseExpression bitwiseExpression;
	public @P(1040) TCL_LogicalAndExpression conditionalAndExpression;
	public @P(1050) TCL_LogicalOrExpression conditionalOrExpression;
}
