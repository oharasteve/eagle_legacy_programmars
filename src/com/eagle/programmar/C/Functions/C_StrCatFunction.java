...
public class C_StrCatFunction extends PrimaryOperator
		implements EagleRunnable, EagleTransformableExpression
{
	public @S(10) C_Keyword STRCAT = new C_Keyword("strcat");
	public @S(20) PunctuationLeftParen leftParen;
	public @S(30) C_VariableExpression varExp;
	...
	public AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator generator)
	{
		...
		return generator.newAssignmentExpression(id.getValue(), SubscriptEnum.FIRST_IS_ZERO, null,
				AssignmentEnum.PLUS_EQUALS, newValue, STRCAT);
	}
}
