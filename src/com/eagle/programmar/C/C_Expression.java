...
import com.eagle.programmar.C.Functions.C_FprintfFunction;
...
public class C_Expression extends PrecedenceChooser
{
	...
	public @P(140) C_FprintfFunction fprintfFunction;
	public @P(150) C_StrCmpFunction strcmpFunction;
	public @P(160) C_StrNCmpFunction strncmpFunction;
	public @P(170) C_StrCatFunction strcatFunction;
	public @P(180) C_StrCpyFunction strcpyFunction;
	public @P(190) C_StrDupFunction strdupFunction;
	public @P(200) C_StrLenFunction strlenFunction;
	public @P(210) C_ExitFunction builtInFunction;
	public @P(220) C_FunctionCall functionCall;
	public @P(230) C_FunctionName functionName;
	public @P(240) C_FunctionPointerCall functionPointerCall;
	public @P(250) C_PreIncrementExpression preIncrementExpression;
	public @P(260) C_PreDecrementExpression preDecrementExpression;
	public @P(270) C_PostIncrementExpression postIncrementExpression;
	public @P(280) C_PostIncrementVariable postIncrementVariable;
	public @P(290) C_PostDecrementExpression postDecrementExpression;
	public @P(300) C_PostDecrementVariable postDecrementVariable;
	public @P(310) C_NegativeExpression signedExpression;
	public @P(320) C_BitwiseNotExpression logicalNotExpression;
	public @P(330) C_LogicalNotExpression notExpression;
	public @P(340) C_BuiltIn builtIn;
	public @P(350) C_VariableExpression variableExpression;
	public @P(360) C_AddressOfVariable addressOfVariable;
	public @P(370) C_SizeOfType sizeOfType;
	public @P(380) C_SizeOfExpr sizeOfExpr;
	public @P(390) C_VaArgExpr vaArgExpr;
	public @P(400) C_Parenthesized_Expression parenthesized_Expression;
	public @P(410) C_StarExpression starExpression;
	public @P(420) C_CommentExpression commentExpression;
	public @P(430) CPlus_NewExpression newExpression;
