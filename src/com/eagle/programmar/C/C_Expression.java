...
import com.eagle.programmar.C.Expressions.C_BuiltInFunction;
...
public class C_Expression extends PrecedenceChooser
{
	...
	public @P(130) C_BuiltInFunction builtInFunction;
	public @P(140) C_FunctionCall functionCall;
	public @P(150) C_FunctionName functionName;
	public @P(160) C_FunctionPointerCall functionPointerCall;
	public @P(170) C_PreIncrementExpression preIncrementExpression;
	public @P(180) C_PreDecrementExpression preDecrementExpression;
	public @P(190) C_PostIncrementExpression postIncrementExpression;
	public @P(200) C_PostIncrementVariable postIncrementVariable;
	public @P(210) C_PostDecrementExpression postDecrementExpression;
	public @P(220) C_PostDecrementVariable postDecrementVariable;
	public @P(230) C_SignedExpression signedExpression;
	public @P(240) C_LogicalNotExpression logicalNotExpression;
	public @P(250) C_NotExpression notExpression;
	public @P(260) C_BuiltIn builtIn;
	public @P(270) C_VariableExpression variableExpression;
