...
public class C_Expression extends PrecedenceChooser
{
	...
	public @P(260) C_PostIncrementVariable postIncrementVariable;
	public @P(270) C_NegativeExpression signedExpression;
	public @P(280) C_BitwiseNotExpression logicalNotExpression;
	public @P(290) C_LogicalNotExpression notExpression;
	public @P(300) C_BuiltIn builtIn;
	public @P(310) C_VariableExpression variableExpression;
	public @P(320) C_AddressOfVariable addressOfVariable;
	public @P(330) C_SizeOfType sizeOfType;
	public @P(340) C_SizeOfExpr sizeOfExpr;
	public @P(350) C_VaArgExpr vaArgExpr;
	public @P(360) C_Parenthesized_Expression parenthesized_Expression;
	public @P(370) C_StarExpression starExpression;
	public @P(380) C_CommentExpression commentExpression;
	public @P(390) CPlus_NewExpression newExpression;
