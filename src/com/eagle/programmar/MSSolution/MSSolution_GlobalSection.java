...
public class MSSolution_GlobalSection extends TokenSequence
{
	...
	public @S(60) MSSolution_KeywordChoice PREPOST = new MSSolution_KeywordChoice(
	...
	public static class MSSolution_GlobalSectionEntryBar extends TokenSequence
	{
		...
		{
			public @CHOICE MSSolution_KeywordChoice acpu = new MSSolution_KeywordChoice(
					".NET", "Win32", "x64", "x86");
	...
	public static class MSSolution_GlobalSectionEntry extends TokenChooser
	{
		...
		{
			public @S(10) MSSolution_KeywordChoice HIDE = new MSSolution_KeywordChoice(
					"SccLocalPath0",
					"SccLocalPath1",
					"SccLocalPath2",
					"SccLocalPath3",
		...
		public @CHOICE static class MSSolution_GlobalSectionEntryUnknown extends TokenSequence
		{
			...
			public static class MSSolution_GlobalSectionEntryRight extends TokenChooser
			{
				...
				public @CHOICE MSSolution_KeywordChoice CONST = new MSSolution_KeywordChoice(
						"FALSE", "true");
