...
{
	public @S(10) Rust_Keyword STATIC = new Rust_Keyword("static");
	public @S(20) Rust_Variable_Definition var;
	public @S(30) PunctuationColon colon;
	public @S(40) Rust_Type type;
	public @S(50) @OPT Rust_Data_Initial init;
