...
public class Rust_Type extends TokenSequence implements AbstractType
{
	public @S(10) @OPT Rust_Punctuation ampersand = new Rust_Punctuation("&");
	public @S(20) @OPT Rust_TypeStatic typeStatic;
	public @S(30) Rust_ActualType actualType;
	
	public static class Rust_TypeStatic extends TokenSequence
	{
		public @S(10) Rust_Punctuation quote = new Rust_Punctuation("'");
		public @S(20) Rust_Keyword STATIC = new Rust_Keyword("static");
	}

	public static class Rust_ActualType extends TokenChooser
	{
		public @CHOICE Rust_KeywordChoice STR = new Rust_KeywordChoice(
				"bool",
				"i32",
				"str",
				"String",
		...
		public @CHOICE static class Rust_TypeArray extends TokenSequence
		{
			...
			public @S(20) Rust_TypeStatic typeStatic;
