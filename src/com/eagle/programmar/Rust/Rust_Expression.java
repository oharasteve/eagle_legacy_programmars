...
public class Rust_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1100) Rust_Subfield subfield;
	public @P(1110) Rust_MultiplicativeExpression multiplicativeExpression;
	public @P(1120) Rust_AdditiveExpression additiveExpression;
	public @P(1130) Rust_ShiftExpression shiftExpression;
	public @P(1140) Rust_RelationalExpression relationalExpression;
