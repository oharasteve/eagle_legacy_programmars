...
public class Rust_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1120) Rust_MinMaxMethod maxmaxMethod;
	public @P(1130) Rust_Subfield subfield;
	public @P(1140) Rust_MultiplicativeExpression multiplicativeExpression;
	public @P(1150) Rust_AdditiveExpression additiveExpression;
	public @P(1160) Rust_ShiftExpression shiftExpression;
	public @P(1170) Rust_RelationalExpression relationalExpression;
	public @P(1180) Rust_BitwiseExpression bitwiseExpression;
	public @P(1190) Rust_LogicalAndExpression conditionalAndExpression;
	public @P(1200) Rust_LogicalOrExpression conditionalOrExpression;
	public @P(1210) Rust_RangeExpression rangeExpression;
	public @P(1220) Rust_AsExpression asExpression;
	public @P(1230) Rust_AssignmentExpression asgExpression;
}
