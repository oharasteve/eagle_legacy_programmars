...
public class Rust_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1060) Rust_ToOwnedMethod toOwnedMethod;
	public @P(1070) Rust_TrimMethod trimMethod;
	public @P(1080) Rust_FindMethod findMethod;
	public @P(1090) Rust_Subfield subfield;
	public @P(1100) Rust_MultiplicativeExpression multiplicativeExpression;
	public @P(1110) Rust_AdditiveExpression additiveExpression;
