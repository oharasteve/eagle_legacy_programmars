...
public class Rust_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1020) Rust_RevMethod revMethod;
	public @P(1030) Rust_StartsWithMethod startsWithMethod;
	public @P(1040) Rust_ToStringMethod toStringMethod;
	public @P(1050) Rust_Subfield subfield;
	public @P(1060) Rust_MultiplicativeExpression multiplicativeExpression;
	public @P(1070) Rust_AdditiveExpression additiveExpression;
