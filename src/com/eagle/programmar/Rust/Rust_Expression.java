...
public class Rust_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1040) Rust_StartsWithMethod startsWithMethod;
	public @P(1050) Rust_ToStringMethod toStringMethod;
	public @P(1060) Rust_Subfield subfield;
	public @P(1070) Rust_MultiplicativeExpression multiplicativeExpression;
	public @P(1080) Rust_AdditiveExpression additiveExpression;
	public @P(1090) Rust_ShiftExpression shiftExpression;
	public @P(1100) Rust_RelationalExpression relationalExpression;
	public @P(1110) Rust_EqualityExpression equalityExpression;
	public @P(1120) Rust_BitwiseExpression bitwiseExpression;
	public @P(1130) Rust_LogicalAndExpression conditionalAndExpression;
	public @P(1140) Rust_LogicalOrExpression conditionalOrExpression;
	public @P(1150) Rust_RangeExpression rangeExpression;
