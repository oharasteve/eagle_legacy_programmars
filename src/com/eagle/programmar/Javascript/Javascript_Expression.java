...
import com.eagle.programmar.Javascript.Functions.Javascript_DocumentWriteln;
...
import com.eagle.programmar.Javascript.Functions.Javascript_MathFloor;
import com.eagle.programmar.Javascript.Functions.Javascript_ParenthesizedFunction;
import com.eagle.programmar.Javascript.Functions.Javascript_StartsWith;
import com.eagle.programmar.Javascript.Functions.Javascript_StrangeFunction;
import com.eagle.programmar.Javascript.Functions.Javascript_StringFunction;
...
public class Javascript_Expression extends PrecedenceChooser
{
	...
	public @P(100) Javascript_DocumentWriteln documentWriteln;
	public @P(110) Javascript_Length lengthFunction;
	public @P(120) Javascript_MathFloor mathFloor;
	public @P(130) Javascript_StartsWith startsWith;
	public @P(140) Javascript_DotClass dotClass;
	public @P(150) Javascript_CastExpression castExpression;
	public @P(160) Javascript_ExpressionList expressionList;
	public @P(170) Javascript_StringFunction stringFunction;
	public @P(180) Javascript_DeleteExpression deleteExpression;
	public @P(190) Javascript_ClassCreationExpression classCreationExpression;
	public @P(200) Javascript_ClassCreationWithInitializers classCreationWithInitializers;
	...
	public @P(260) Javascript_PreDecrementExpression preDecrementExpression;
	public @P(270) Javascript_PostIncrementExpression postIncrementExpression;
	public @P(280) Javascript_PostDecrementExpression postDecrementExpression;
	public @P(290) Javascript_NegativeExpression negativeExpression;
	public @P(300) Javascript_LogicalNotExpression logicalNotExpression;
	public @P(310) Javascript_NotExpression notExpression;
	public @P(320) Javascript_BuiltInVar builtInVar;
	public @P(330) Javascript_TemplateExpr templateExpr;
	public @P(340) Javascript_LambdaFunction lambdaFunction;
	public @P(350) Javascript_VariableExpression variableExpression;
	public @P(360) Javascript_StrangeFunction strangeFunction;
	public @P(370) Javascript_ParenthesizedFunction parenthesizedFunction;
	public @P(380) Javascript_Parenthesized_Expression parenthesized_Expression;
	public @P(390) Javascript_SimpleArray simpleArray;
	public @P(400) Javascript_CommentExpression commentExpression;
	public @P(410) Javascript_ObjectLiteral objectLiteral;
	public @P(420) Javascript_FunctionExpr functionExpr;
	public @P(430) Javascript_ClassExpr classExpr;
	public @P(440) Javascript_TypeOfExpr typeOfExpr;
	public @P(450) Javascript_VoidExpr voidExpr;
	public @P(460) Javascript_EllipsisExpr ellipsisExpr;
