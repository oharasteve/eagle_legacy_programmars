...
public class Javascript_Expression extends PrecedenceChooser
{
	...
	public @P(140) Javascript_EvalFunction evalFunction;
	public @P(150) Javascript_DotClass dotClass;
	public @P(160) Javascript_CastExpression castExpression;
	public @P(170) Javascript_ExpressionList expressionList;
	public @P(180) Javascript_StringFunction stringFunction;
	public @P(190) Javascript_DeleteExpression deleteExpression;
	public @P(200) Javascript_ClassCreationExpression classCreationExpression;
	public @P(210) Javascript_ClassCreationWithInitializers classCreationWithInitializers;
	public @P(220) Javascript_ClassCreationWithSubscript classCreationWithSubscript;
	public @P(230) Javascript_NewNoArgsExpression newNoArgsExpression;
	public @P(240) Javascript_AwaitFunctionCall awaitFunctionCall;
	public @P(250) Javascript_FunctionCall functionCall;
	public @P(260) Javascript_PreIncrementExpression preIncrementExpression;
	public @P(270) Javascript_PreDecrementExpression preDecrementExpression;
	...
	public @P(360) Javascript_VariableExpression variableExpression;
	public @P(370) Javascript_StrangeFunction strangeFunction;
	public @P(380) Javascript_ParenthesizedFunction parenthesizedFunction;
	public @P(390) Javascript_Parenthesized_Expression parenthesized_Expression;
	public @P(400) Javascript_SimpleArray simpleArray;
	public @P(410) Javascript_CommentExpression commentExpression;
	public @P(420) Javascript_ObjectLiteral objectLiteral;
	public @P(430) Javascript_FunctionExpr functionExpr;
	public @P(440) Javascript_ClassExpr classExpr;
	public @P(450) Javascript_TypeOfExpr typeOfExpr;
	public @P(460) Javascript_VoidExpr voidExpr;
	public @P(470) Javascript_EllipsisExpr ellipsisExpr;
