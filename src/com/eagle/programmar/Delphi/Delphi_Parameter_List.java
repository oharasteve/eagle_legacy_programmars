...
public class Delphi_Parameter_List extends TokenSequence
{
	...
	public @S(20) @OPT Delphi_Parameter firstParam;
	public @S(30) @OPT TokenList<Delphi_MoreParameters> moreParams;
	public @S(40) PunctuationRightParen rightParen;

	public static class Delphi_Parameter extends TokenSequence
	{
	...
	public static class Delphi_MoreParameters extends TokenSequence
	{
		public @S(10) PunctuationSemicolon semicolon;
		public @S(20) @OPT Delphi_Parameter param;
	}
