...
public class COBOL_Type extends TokenChooser
{
	...
	public @CHOICE COBOL_KeywordChoice XXtype = new COBOL_KeywordChoice("1-RECTL", "2SIZE",
			"BINARY-LONG", "BYTE", "CLIPFORMAT", "CLSID", "DATA-POINTER", "DWORD", "FILETIME",
			"FLOAT-LONG", "FORMATETC", "IID", "LONG", "POINT", "POINTER", "PROCEDURE-POINTER",
			"TAGMSG", "TAGPOINT", "TAGRECT", "TAGSIZE", "UINT", "ULARGE-INTEGER", "ULONG",
			"USHORT", "VARTYPE", "WORD", "WRAPPED-BYTE");
