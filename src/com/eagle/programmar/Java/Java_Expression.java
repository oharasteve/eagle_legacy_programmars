...
public class Java_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1070) Java_ToStringMethod toStringMethod;
	public @P(1080) Java_SubfieldExpression subfield;
	public @P(1090) Java_ColonColon colonColon;
	public @P(1100) Java_ColonColonNew colonColonNew;
	public @P(1110) Java_MultiplicativeExpression multiplicativeExpression;
	public @P(1120) Java_AdditiveExpression additiveExpression;
	public @P(1130) Java_ShiftExpression shiftExpression;
	public @P(1140) Java_InstanceOfExpression instanceOfExpression;
	public @P(1150) Java_RelationalExpression relationalExpression;
	public @P(1160) Java_BitwiseAndExpression andExpression;
