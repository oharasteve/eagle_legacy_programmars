...
import com.eagle.programmar.Java.Functions.Java_StringFunction;
...
public class Java_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(120) Java_StringFunction stringFunction;
	public @P(130) Java_DotClass dotClass;
	public @P(140) Java_LambdaExpression lambdaExpression;
	public @P(150) Java_CastExpression castExpression;
	public @P(160) Java_ExpressionList expressionList;
	public @P(170) Java_InterfaceCreationWithMethod interfaceCreationWithMethod;
	public @P(180) Java_ClassCreationExpression classCreationExpression;
	public @P(190) Java_ClassCreationWithInitializers classCreationWithInitializers;
	public @P(200) Java_ClassCreationWithSubscript classCreationWithSubscript;
	public @P(210) Java_MethodInvocation methodInvocation;
	public @P(220) Java_AnnotationInvocation annotationInvocation;
	public @P(230) Java_PreIncrementExpression preIncrementExpression;
	public @P(240) Java_PostIncrementExpression postIncrementExpression;
	public @P(250) Java_NegativeExpression negativeExpression;
	public @P(260) Java_BitwiseNotExpression logicalNotExpression;
	public @P(270) Java_LogicalNotExpression notExpression;
	...
	public @P(1040) Java_TrimMethod trimMethod;
	public @P(1050) Java_StartsWithMethod startsWithMethod;
	public @P(1060) Java_SubstringMethod substringMethod;
	public @P(1070) Java_IndexOfMethod indexOfMethod;
	public @P(1080) Java_ToStringMethod toStringMethod;
	public @P(1090) Java_SubfieldExpression subfield;
	public @P(1100) Java_ColonColon colonColon;
	public @P(1110) Java_ColonColonNew colonColonNew;
	public @P(1120) Java_MultiplicativeExpression multiplicativeExpression;
	public @P(1130) Java_AdditiveExpression additiveExpression;
	public @P(1140) Java_ShiftExpression shiftExpression;
	public @P(1150) Java_InstanceOfExpression instanceOfExpression;
	public @P(1160) Java_RelationalExpression relationalExpression;
	public @P(1170) Java_BitwiseAndExpression andExpression;
	public @P(1180) Java_BitwiseOrExpression inclusiveOrExpression;
	public @P(1190) Java_LogicalAndExpression conditionalAndExpression;
	public @P(1200) Java_LogicalOrExpression conditionalOrExpression;
