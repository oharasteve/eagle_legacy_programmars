...
import com.eagle.programmar.Java.Methods.Java_ToUpperCaseMethod;
...
public class Java_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(130) Java_PrintFunction printFunction;
	public @P(140) Java_DotClass dotClass;
	public @P(150) Java_LambdaExpression lambdaExpression;
	public @P(160) Java_CastExpression castExpression;
	public @P(170) Java_ExpressionList expressionList;
	public @P(180) Java_InterfaceCreationWithMethod interfaceCreationWithMethod;
	public @P(190) Java_ClassCreationExpression classCreationExpression;
	public @P(200) Java_ClassCreationWithInitializers classCreationWithInitializers;
	public @P(210) Java_ClassCreationWithSubscript classCreationWithSubscript;
	public @P(220) Java_MethodInvocation methodInvocation;
	public @P(230) Java_AnnotationInvocation annotationInvocation;
	public @P(240) Java_PreIncrementExpression preIncrementExpression;
	public @P(250) Java_PostIncrementExpression postIncrementExpression;
	...
	public @P(1060) Java_EndsWithMethod endsWithMethod;
	public @P(1070) Java_SubstringMethod substringMethod;
	public @P(1080) Java_IndexOfMethod indexOfMethod;
	public @P(1090) Java_ToStringMethod toStringMethod;
	public @P(1100) Java_SubfieldExpression subfield;
	public @P(1110) Java_ColonColon colonColon;
	public @P(1120) Java_ColonColonNew colonColonNew;
	public @P(1130) Java_MultiplicativeExpression multiplicativeExpression;
	public @P(1140) Java_AdditiveExpression additiveExpression;
