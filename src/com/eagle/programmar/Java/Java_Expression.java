...
public class Java_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1050) Java_MathPowFunction mathPowFunction;
	public @P(1060) Java_SubstringMethod substringMethod;
	public @P(1070) Java_SubfieldExpression subfield;
	public @P(1080) Java_ColonColon colonColon;
	public @P(1090) Java_ColonColonNew colonColonNew;
	public @P(1100) Java_MultiplicativeExpression multiplicativeExpression;
	public @P(1110) Java_AdditiveExpression additiveExpression;
	public @P(1120) Java_ShiftExpression shiftExpression;
	public @P(1130) Java_RelationalExpression relationalExpression;
	public @P(1140) Java_InstanceOfExpression instanceOfExpression;
	public @P(1150) Java_BitwiseAndExpression andExpression;
	public @P(1160) Java_ExclusiveOrExpression exclusiveOrExpression;
	public @P(1170) Java_BitwiseOrExpression inclusiveOrExpression;
	public @P(1180) Java_LogicalAndExpression conditionalAndExpression;
	public @P(1190) Java_LogicalOrExpression conditionalOrExpression;
	public @P(1200) Java_AssignmentExpression assignmentExpression;
	public @P(1210) Java_TrueFalseExpression trueFalseExpression;
}
