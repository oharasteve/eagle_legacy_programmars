...
public class Java_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(520) Java_LengthMethod lengthMethod;
	public @P(530) Java_StartsWithMethod startsWithMethod;
	public @P(540) Java_SubfieldExpression subfield;
	public @P(550) Java_ColonColon colonColon;
	public @P(560) Java_ColonColonNew colonColonNew;
	public @P(570) Java_MultiplicativeExpression multiplicativeExpression;
	public @P(580) Java_AdditiveExpression additiveExpression;
	public @P(590) Java_ShiftExpression shiftExpression;
	public @P(600) Java_RelationalExpression relationalExpression;
	public @P(610) Java_InstanceOfExpression instanceOfExpression;
	public @P(620) Java_EqualityExpression equalityExpression;
	public @P(630) Java_AndExpression andExpression;
	public @P(640) Java_ExclusiveOrExpression exclusiveOrExpression;
	public @P(650) Java_InclusiveOrExpression inclusiveOrExpression;
	public @P(660) Java_ConditionalAndExpression conditionalAndExpression;
	public @P(670) Java_ConditionalOrExpression conditionalOrExpression;
	public @P(680) Java_AssignmentExpression assignmentExpression;
	public @P(690) Java_TrueFalseExpression trueFalseExpression;
}
