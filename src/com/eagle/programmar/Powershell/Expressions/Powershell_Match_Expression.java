...
public class Powershell_Match_Expression extends PrecedenceOperator
{
	...
	public @S(20) Powershell_KeywordChoice operator = new Powershell_KeywordChoice("-cmatch", "-cnotmatch",
			"-contains", "-f", "-in", "-join", "-match", "-notin", "-notlike", "-notmatch", "-replace", "-split");
	public @S(30) Powershell_ExpressionList right = new Powershell_ExpressionList();
}
