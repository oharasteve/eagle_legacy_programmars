...
// Original author: Steven A. O'Hara, May 23, 2026
...
public class Perl_FloatValFunction extends PrimaryOperator
		implements EagleRunnable, EagleTransformableExpression
{
	public @S(10) Perl_Keyword FLOATVAL = new Perl_Keyword("floatval");
