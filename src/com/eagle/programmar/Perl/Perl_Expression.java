...
public class Perl_Expression extends PrecedenceChooser
{
	...
	public @P(290) Perl_StrLenFunction strlenFunction;
	public @P(300) Perl_SubstrFunction substrFunction;
	public @P(310) Perl_FunctionCall functionCall;
	public @P(320) Perl_VariableExpression variableExpression;
	public @P(330) Perl_ParenthesizedExpression parenthesizedExpression;
	public @P(340) Perl_BracketedExpression bracketedExpression;
	public @P(350) Perl_EachExpression eachExpression;
	public @P(360) Perl_DieExpression dieExpression;
	public @P(370) Perl_AddressOfExpression addressOfExpression;
	public @P(380) Perl_FunctionExpression functionExpression;
	public @P(390) Perl_FileIO fileIO;
	public @P(400) Perl_PercentExpression percentExpression;
	public @P(410) Perl_JoinExpression joinExpression;
