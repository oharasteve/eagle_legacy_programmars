...
public class Perl_Expression extends PrecedenceChooser
{
	...
	public @P(140) Perl_MethodInvocation methodInvocation;
	public @P(150) Perl_BracesInvocation bracesInvocation;	
	public @P(160) Perl_PreIncrementExpression preIncrementExpression;
	public @P(170) Perl_PreDecrementExpression preDecrementExpression;
	public @P(180) Perl_PostIncrementExpression postIncrementExpression;
	public @P(190) Perl_PostDecrementExpression postDecrementExpression;
	public @P(200) Perl_ExistsExpression existsExpression;
	public @P(210) Perl_NegativeExpression negativeExpression;
	public @P(220) Perl_LogicalNotExpression logicalNotExpression;
	public @P(230) Perl_NotExpression notExpression;
	public @P(240) Perl_StarExpression starExpression;
	public @P(250) Perl_GrepExpression grepExpression;
	public @P(260) Perl_BuiltIn builtIn;
	public @P(270) Perl_RegExExpression regExExpression;
	public @P(280) Perl_FunctionCall functionCall;
	public @P(290) Perl_VariableExpression variableExpression;
	public @P(300) Perl_ParenthesizedExpression parenthesizedExpression;
	public @P(310) Perl_BracketedExpression bracketedExpression;
	public @P(320) Perl_EachExpression eachExpression;
	public @P(330) Perl_DieExpression dieExpression;
	public @P(340) Perl_AddressOfExpression addressOfExpression;
	public @P(350) Perl_FunctionExpression functionExpression;
	public @P(360) Perl_FileIO fileIO;
	public @P(370) Perl_PercentExpression percentExpression;
	public @P(380) Perl_JoinExpression joinExpression;
