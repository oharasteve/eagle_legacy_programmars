...
import com.eagle.programmar.Perl.Expressions.Perl_BitwiseAndExpression;
...
import com.eagle.programmar.Perl.Expressions.Perl_BitwiseXorExpression;
...
import com.eagle.programmar.Perl.Expressions.Perl_BitwiseOrExpression;
...
import com.eagle.programmar.Perl.Functions.Perl_FunctionCall;
...
public class Perl_Expression extends PrecedenceChooser
{
	...
	public @P(230) Perl_BitwiseNotExpression logicalNotExpression;
	public @P(240) Perl_LogicalNotExpression notExpression;
	public @P(250) Perl_StarExpression starExpression;
	public @P(260) Perl_GrepExpression grepExpression;
	public @P(270) Perl_ReadExpression readExpression;
	public @P(280) Perl_BuiltIn builtIn;
	public @P(290) Perl_RegExExpression regExExpression;
	public @P(300) Perl_ArrayFunction arrayFunction;
	...
	public @P(1130) Perl_BitwiseAndExpression andExpression;
	public @P(1140) Perl_BitwiseXorExpression exclusiveOrExpression;
	public @P(1150) Perl_BitwiseOrExpression inclusiveOrExpression;
	public @P(1160) Perl_LogicalAndExpression conditionalAndExpression;
	public @P(1170) Perl_LogicalOrExpression conditionalOrExpression;
