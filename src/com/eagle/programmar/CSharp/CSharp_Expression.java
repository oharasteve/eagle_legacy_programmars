...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(580) CSharp_EqualityExpression equalityExpression;
	public @P(590) CSharp_AndExpression andExpression;
	public @P(600) CSharp_ExclusiveOrExpression exclusiveOrExpression;
	public @P(610) CSharp_InclusiveOrExpression inclusiveOrExpression;
	public @P(620) CSharp_ConditionalAndExpression conditionalAndExpression;
	public @P(630) CSharp_ConditionalOrExpression conditionalOrExpression;
	public @P(640) CSharp_TrueFalseExpression trueFalseExpression;
	public @P(650) CSharp_AssignmentExpression assignmentExpression;
	public @P(660) CSharp_LambdaFunction lambdaFunction;
	public @P(670) CSharp_LambdaExpression lambdaExpression;
}
