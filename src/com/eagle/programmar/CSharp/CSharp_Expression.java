...
import com.eagle.programmar.CSharp.Expressions.CSharp_BitwiseAndExpression;
import com.eagle.programmar.CSharp.Expressions.CSharp_BitwiseNotExpression;
import com.eagle.programmar.CSharp.Expressions.CSharp_BitwiseOrExpression;
...
import com.eagle.programmar.CSharp.Functions.CSharp_ToUpperMethod;
...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(110) CSharp_DotClass dotClass;
	public @P(120) CSharp_CastExpression castExpression;
	public @P(130) CSharp_ExpressionList expressionList;
	public @P(140) CSharp_InterfaceCreationWithMethod interfaceCreationWithMethod;
	public @P(150) CSharp_ClassCreationExpression classCreationExpression;
	public @P(160) CSharp_ClassCreationWithInitializers classCreationWithInitializers;
	public @P(170) CSharp_ClassCreationWithSubscript classCreationWithSubscript;
	public @P(180) CSharp_MethodInvocation methodInvocation;
	public @P(190) CSharp_PreIncrementExpression preIncrementExpression;
	public @P(200) CSharp_PostIncrementExpression postIncrementExpression;
	public @P(210) CSharp_NegativeExpression negativeExpression;
	public @P(220) CSharp_BitwiseNotExpression logicalNotExpression;
	public @P(230) CSharp_LogicalNotExpression notExpression;
	public @P(240) CSharp_DefaultGeneric defaultGeneric;
	public @P(250) CSharp_BuiltIn builtIn;
	public @P(260) CSharp_ConsoleOut consoleOut;
	public @P(270) CSharp_ConsoleRead consoleRead;
	...
	public @P(320) CSharp_SizeOfFunction typeOf;
	...
	public @P(1100) CSharp_StringFormatFunc stringFormat;
	public @P(1110) CSharp_MultiplicativeExpression multiplicativeExpression;
	public @P(1120) CSharp_AdditiveExpression additiveExpression;
	public @P(1130) CSharp_ShiftExpression shiftExpression;
	public @P(1140) CSharp_RelationalExpression relationalExpression;
	public @P(1150) CSharp_InstanceOfExpression instanceOfExpression;
	public @P(1160) CSharp_CastAsExpression castAsExpression;
	public @P(1170) CSharp_EqualityExpression equalityExpression;
	public @P(1180) CSharp_BitwiseAndExpression andExpression;
	public @P(1190) CSharp_BitwiseOrExpression inclusiveOrExpression;
	public @P(1200) CSharp_LogicalAndExpression conditionalAndExpression;
	public @P(1210) CSharp_LogicalOrExpression conditionalOrExpression;
	public @P(1220) CSharp_TrueFalseExpression trueFalseExpression;
	public @P(1230) CSharp_AssignmentExpression assignmentExpression;
	public @P(1240) CSharp_LambdaFunction lambdaFunction;
	public @P(1250) CSharp_LambdaExpression lambdaExpression;
}
