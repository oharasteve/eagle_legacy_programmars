...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1040) CSharp_TrimMethod trimMethod;
	public @P(1050) CSharp_ToStringMethod toStringMethod;
	public @P(1060) CSharp_SubstringMethod substringMethod;
	public @P(1070) CSharp_StartsWithMethod startswithMethod;
	public @P(1080) CSharp_SubfieldExpression subfieldExpression;
	public @P(1090) CSharp_MultiplicativeExpression multiplicativeExpression;
	public @P(1100) CSharp_AdditiveExpression additiveExpression;
	public @P(1110) CSharp_ShiftExpression shiftExpression;
	public @P(1120) CSharp_RelationalExpression relationalExpression;
	public @P(1130) CSharp_InstanceOfExpression instanceOfExpression;
	public @P(1140) CSharp_CastAsExpression castAsExpression;
	public @P(1150) CSharp_EqualityExpression equalityExpression;
	public @P(1160) CSharp_BitwiseAndExpression andExpression;
	public @P(1170) CSharp_BitwiseOrExpression inclusiveOrExpression;
