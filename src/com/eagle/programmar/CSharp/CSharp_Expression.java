...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(1080) CSharp_MultiplicativeExpression multiplicativeExpression;
	public @P(1090) CSharp_AdditiveExpression additiveExpression;
	public @P(1100) CSharp_ShiftExpression shiftExpression;
	public @P(1110) CSharp_RelationalExpression relationalExpression;
	public @P(1120) CSharp_InstanceOfExpression instanceOfExpression;
	public @P(1130) CSharp_CastAsExpression castAsExpression;
	public @P(1140) CSharp_EqualityExpression equalityExpression;
	public @P(1150) CSharp_BitwiseAndExpression andExpression;
