...
import com.eagle.programmar.CSharp.Functions.CSharp_SizeOf;
...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(530) CSharp_SubstringMethod substringMethod;
	public @P(540) CSharp_StartsWithMethod startswithMethod;
	public @P(550) CSharp_SubfieldExpression subfieldExpression;
	public @P(560) CSharp_MultiplicativeExpression multiplicativeExpression;
	public @P(570) CSharp_AdditiveExpression additiveExpression;
	public @P(580) CSharp_ShiftExpression shiftExpression;
	public @P(590) CSharp_RelationalExpression relationalExpression;
	public @P(600) CSharp_InstanceOfExpression instanceOfExpression;
	public @P(610) CSharp_CastAsExpression castAsExpression;
	public @P(620) CSharp_EqualityExpression equalityExpression;
	public @P(630) CSharp_AndExpression andExpression;
	public @P(640) CSharp_ExclusiveOrExpression exclusiveOrExpression;
	public @P(650) CSharp_InclusiveOrExpression inclusiveOrExpression;
	public @P(660) CSharp_ConditionalAndExpression conditionalAndExpression;
	public @P(670) CSharp_ConditionalOrExpression conditionalOrExpression;
	public @P(680) CSharp_TrueFalseExpression trueFalseExpression;
	public @P(690) CSharp_AssignmentExpression assignmentExpression;
	public @P(700) CSharp_LambdaFunction lambdaFunction;
	public @P(710) CSharp_LambdaExpression lambdaExpression;
}
