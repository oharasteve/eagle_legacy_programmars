...
public class CSharp_Expression extends PrecedenceChooser implements AbstractExpression
{
	...
	public @P(120) CSharp_DotClass dotClass;
	public @P(130) CSharp_CastExpression castExpression;
	public @P(140) CSharp_ExpressionList expressionList;
	public @P(150) CSharp_InterfaceCreationWithMethod interfaceCreationWithMethod;
	public @P(160) CSharp_ClassCreationExpression classCreationExpression;
	public @P(170) CSharp_ClassCreationWithInitializers classCreationWithInitializers;
	public @P(180) CSharp_ClassCreationWithSubscript classCreationWithSubscript;
	public @P(190) CSharp_MethodInvocation methodInvocation;
	public @P(200) CSharp_PreIncrementExpression preIncrementExpression;
	public @P(210) CSharp_PostIncrementExpression postIncrementExpression;
	public @P(220) CSharp_NegativeExpression negativeExpression;
	public @P(230) CSharp_BitwiseNotExpression logicalNotExpression;
	public @P(240) CSharp_LogicalNotExpression notExpression;
	...
	public @P(290) CSharp_VariableExpression variableExpression;
	...
	public @P(330) CSharp_SizeOfFunction typeOf;
