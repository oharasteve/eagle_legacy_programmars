...
public class Haskell_IfStatement extends TokenSequence
{
	...
	public @S(30) Haskell_Keyword THEN = new Haskell_Keyword("then");
	public @S(40) Haskell_Statement thenStatement;
	public @S(50) Haskell_Keyword ELSE = new Haskell_Keyword("else");
	public @S(60) Haskell_Statement elseStatement;
}
