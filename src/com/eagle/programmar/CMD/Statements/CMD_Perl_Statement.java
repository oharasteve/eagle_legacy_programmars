...
public class CMD_Perl_Statement extends TokenSequence implements AbstractStatement
{
	...
	public static class CMD_Perl_Option extends TokenChooser
	{
		...
		{
			public @S(10) CMD_Punctuation dash = new CMD_Punctuation('-');
			public @S(20) CMD_Keyword E = new CMD_Keyword("e");
			public @S(30) Perl_Literal literal;
		}
	}
}
