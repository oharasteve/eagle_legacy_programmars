...
namespace com.eagle.programmar.C.Statements
{
	...
	public class C_WhileStatement : TokenSequence, AbstractStatement, EagleRunnableWithResult, EagleTransformableStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) @DOC("#The-while-Statement") com.eagle.programmar.C.Terminals.C_Keyword WHILE = new com.eagle.programmar.C.Terminals.C_Keyword("while");
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(60) com.eagle.programmar.C.C_Statement whileStatement;
