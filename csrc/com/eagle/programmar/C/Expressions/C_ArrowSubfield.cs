...
namespace com.eagle.programmar.C.Expressions
{
	...
	public class C_ArrowSubfield : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.C.Terminals.C_Punctuation arrow = new com.eagle.programmar.C.Terminals.C_Punctuation("->");
		public C_Punctuation arrow = new C_Punctuation("->");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.C.C_Expression rightArrow = new com.eagle.programmar.C.C_Expression(this, AllowedPrecedence.HIGHER);
		public C_Expression rightArrow = new C_Expression(this, AllowedPrecedence.HIGHER);
	}
