...
namespace com.eagle.programmar.C.Expressions
{
	...
	public class C_DotSubfield : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.C.C_Expression rightSub = new com.eagle.programmar.C.C_Expression(this, AllowedPrecedence.HIGHER);
		public C_Expression rightSub = new C_Expression(this, AllowedPrecedence.HIGHER);
	}
