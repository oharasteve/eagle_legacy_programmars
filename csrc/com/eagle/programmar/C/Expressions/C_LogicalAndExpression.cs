...
namespace com.eagle.programmar.C.Expressions
{
	...
	public class C_LogicalAndExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.C.Terminals.C_Punctuation andOperator = new com.eagle.programmar.C.Terminals.C_Punctuation("&&");
