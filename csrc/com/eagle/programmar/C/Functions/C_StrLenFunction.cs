...
namespace com.eagle.programmar.C.Functions
{
	...
	public class C_StrLenFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.C.Terminals.C_Keyword STRLEN = new com.eagle.programmar.C.Terminals.C_Keyword("strlen");
		public C_Keyword STRLEN = new C_Keyword("strlen");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
