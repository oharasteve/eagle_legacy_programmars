...
namespace com.eagle.programmar.Django.Terminals
{
	...
	public class Django_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public Django_PunctuationChoice() : base()
		{
		}

		public Django_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
