...
namespace com.eagle.programmar.Django.Expressions
{
	...
	public class Django_InExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Django.Terminals.Django_Keyword IN = new com.eagle.programmar.Django.Terminals.Django_Keyword("in");
