...
namespace com.eagle.programmar.Django.Expressions
{
	...
	public class Django_FormatExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Django.Terminals.Django_Punctuation percent = new com.eagle.programmar.Django.Terminals.Django_Punctuation("%");
		public Django_Punctuation percent = new Django_Punctuation("%");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
