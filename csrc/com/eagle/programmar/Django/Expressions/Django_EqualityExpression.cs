...
namespace com.eagle.programmar.Django.Expressions
{
	...
	public class Django_EqualityExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Django.Terminals.Django_PunctuationChoice operator = new com.eagle.programmar.Django.Terminals.Django_PunctuationChoice("==", "!=", "<=", ">=", "<", ">");
		public Django_PunctuationChoice @operator = new Django_PunctuationChoice("==", "!=", "<=", ">=", "<", ">");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
