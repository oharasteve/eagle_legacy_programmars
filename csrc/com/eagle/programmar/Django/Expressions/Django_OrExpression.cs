...
namespace com.eagle.programmar.Django.Expressions
{
	...
	public class Django_OrExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Django.Terminals.Django_Keyword AND = new com.eagle.programmar.Django.Terminals.Django_Keyword("and");
		public Django_Keyword AND = new Django_Keyword("and");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
