...
namespace com.eagle.programmar.Django.Controls
{
	...
	public class Django_SpacelessControl : TokenSequence
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Django.Terminals.Django_KeywordChoice SPACELESS = new com.eagle.programmar.Django.Terminals.Django_KeywordChoice("spaceless", "endspaceless");
