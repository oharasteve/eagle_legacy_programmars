...
namespace com.eagle.programmar.Go.Expressions
{
	...
	public class Go_LogicalAndExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Go.Terminals.Go_Punctuation andOperator = new com.eagle.programmar.Go.Terminals.Go_Punctuation("&&");
		public Go_Punctuation andOperator = new Go_Punctuation("&&");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
