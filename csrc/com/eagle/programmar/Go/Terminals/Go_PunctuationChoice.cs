...
namespace com.eagle.programmar.Go.Terminals
{
	...
	public class Go_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public Go_PunctuationChoice() : base()
		{
		}

		public Go_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
