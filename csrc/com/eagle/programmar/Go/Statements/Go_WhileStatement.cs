...
namespace com.eagle.programmar.Go.Statements
{
	...
	public class Go_WhileStatement : TokenSequence, EagleRunnableWithResult, AbstractStatement, EagleTransformableStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Go.Terminals.Go_Keyword FOR = new com.eagle.programmar.Go.Terminals.Go_Keyword("for");
		public Go_Keyword FOR = new Go_Keyword("for");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
