...
namespace com.eagle.programmar.RPGFree.Expressions
{
	...
	public class RPGFree_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.RPGFree.Terminals.RPGFree_PunctuationChoice operator = new com.eagle.programmar.RPGFree.Terminals.RPGFree_PunctuationChoice("-", "+");
		public RPGFree_PunctuationChoice @operator = new RPGFree_PunctuationChoice("-", "+");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.RPGFree.RPGFree_Expression expr;
