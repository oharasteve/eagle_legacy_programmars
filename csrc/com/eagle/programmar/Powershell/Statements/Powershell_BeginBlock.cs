...
namespace com.eagle.programmar.Powershell.Statements
{
	...
	public class Powershell_BeginBlock : TokenSequence, AbstractStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Powershell.Terminals.Powershell_Keyword BEGIN = new com.eagle.programmar.Powershell.Terminals.Powershell_Keyword("Begin");
		public Powershell_Keyword BEGIN = new Powershell_Keyword("Begin");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
