...
namespace com.eagle.programmar.Powershell.Expressions
{
	...
	public class Powershell_VariableExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
		// Because Powershell_Variable is not a TerminalToken,
		// it has to be wrapped in a PrimaryOperator
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Powershell.Powershell_Variable variable;
		public Powershell_Variable variable;
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			return generator.newVariableExpression(variable.id.getValue(), EagleGenerator.SubscriptEnum.FIRST_IS_ZERO, subscrExpr, this);
		}
	}
