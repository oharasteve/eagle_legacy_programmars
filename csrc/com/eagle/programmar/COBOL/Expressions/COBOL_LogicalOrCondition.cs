...
namespace com.eagle.programmar.COBOL.Expressions
{
	...
	public class COBOL_LogicalOrCondition : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.COBOL.Terminals.COBOL_Keyword OR = new com.eagle.programmar.COBOL.Terminals.COBOL_Keyword("OR");
...
// ORIGINAL LINE: public @S(40) com.eagle.programmar.COBOL.COBOL_Expression right = new com.eagle.programmar.COBOL.COBOL_Expression(this, AllowedPrecedence.HIGHER);
		...
		public override void interpret(EagleInterpreter interpreter)
		{
			...
			{
				throw new Exception("Can't handle OR with relational operators yet");
			}
