...
namespace com.eagle.programmar.COBOL.Expressions
{
	...
	public class COBOL_ExponentExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.COBOL.Terminals.COBOL_Punctuation starStar = new com.eagle.programmar.COBOL.Terminals.COBOL_Punctuation("**");
		public COBOL_Punctuation starStar = new COBOL_Punctuation("**");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
