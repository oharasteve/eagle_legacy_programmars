...
namespace com.eagle.programmar.COBOL.Screen
{
	...
	public class COBOL_ScreenPictureVariable : TokenSequence
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.COBOL.Terminals.COBOL_Keyword X = new com.eagle.programmar.COBOL.Terminals.COBOL_Keyword("X");
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) com.eagle.programmar.COBOL.COBOL_Expression size;
