...
namespace com.eagle.programmar.COBOL.Functions
{
	...
	public class COBOL_LengthFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.COBOL.Terminals.COBOL_Keyword LENGTH = new com.eagle.programmar.COBOL.Terminals.COBOL_Keyword("LENGTH");
