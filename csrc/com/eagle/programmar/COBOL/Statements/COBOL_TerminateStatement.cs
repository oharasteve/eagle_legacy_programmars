...
namespace com.eagle.programmar.COBOL.Statements
{
	...
	public class COBOL_TerminateStatement : COBOL_AbstractStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.COBOL.Terminals.COBOL_Keyword TERMINATE = new com.eagle.programmar.COBOL.Terminals.COBOL_Keyword("TERMINATE");
		public COBOL_Keyword TERMINATE = new COBOL_Keyword("TERMINATE");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.COBOL.Symbols.COBOL_Identifier_Reference report;
