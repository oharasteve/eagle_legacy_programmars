...
namespace com.eagle.programmar.CMD.Terminals
{
	...
	public class CMD_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public CMD_PunctuationChoice() : base()
		{
		}

		public CMD_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
