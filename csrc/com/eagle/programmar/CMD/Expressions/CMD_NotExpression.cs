...
namespace com.eagle.programmar.CMD.Expressions
{
	...
	public class CMD_NotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.CMD.Terminals.CMD_Keyword NOT = new com.eagle.programmar.CMD.Terminals.CMD_Keyword("NOT");
		public CMD_Keyword NOT = new CMD_Keyword("NOT");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// ORIGINAL LINE: private @SKIP Operator1Metrics _metrics = null;
		...
		public override void interpret(EagleInterpreter interpreter)
		{
			...
			bool val = value.forceBooleanValue();
