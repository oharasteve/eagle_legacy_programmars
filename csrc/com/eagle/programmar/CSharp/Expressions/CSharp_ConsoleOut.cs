...
namespace com.eagle.programmar.CSharp.Expressions
{
	...
	public class CSharp_ConsoleOut : PrimaryOperator
	{
...
// ORIGINAL LINE: public @S(40) @NOSPACE PunctuationPeriod dot2;
		public  NOSPACE;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(50) @NOSPACE CSharp_KeywordChoice OUT = new com.eagle.programmar.CSharp.Terminals.CSharp_KeywordChoice("Error", "In", "Out");
		public  NOSPACE;
	}
