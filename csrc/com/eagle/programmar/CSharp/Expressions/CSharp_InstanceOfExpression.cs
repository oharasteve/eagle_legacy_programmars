...
namespace com.eagle.programmar.CSharp.Expressions
{
	...
	public class CSharp_InstanceOfExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.CSharp.Terminals.CSharp_Keyword IS = new com.eagle.programmar.CSharp.Terminals.CSharp_Keyword("is");
		public CSharp_Keyword IS = new CSharp_Keyword("is");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
