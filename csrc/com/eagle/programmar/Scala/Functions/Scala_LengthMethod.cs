...
namespace com.eagle.programmar.Scala.Functions
{
	...
	public class Scala_LengthMethod : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Scala.Terminals.Scala_Keyword LENGTH = new com.eagle.programmar.Scala.Terminals.Scala_Keyword("length");
		public Scala_Keyword LENGTH = new Scala_Keyword("length");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
