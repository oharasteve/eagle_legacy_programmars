...
namespace com.eagle.programmar.Scala.Expressions
{
	...
	public class Scala_LogicalNotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Scala.Terminals.Scala_Punctuation logicalNotOperator = new com.eagle.programmar.Scala.Terminals.Scala_Punctuation('~');
		public Scala_Punctuation logicalNotOperator = new Scala_Punctuation('~');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
