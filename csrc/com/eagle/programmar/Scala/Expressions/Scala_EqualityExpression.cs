...
namespace com.eagle.programmar.Scala.Expressions
{
	...
	public class Scala_EqualityExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: private @SKIP Operator2Metrics _metrics = null;
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			default:
				throw new Exception("Unexpected equality operator: " + @operator);
			}
		}
	}
