...
namespace com.eagle.programmar.Scala.Expressions
{
	...
	public class Scala_NotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Scala.Terminals.Scala_Punctuation notOperator = new com.eagle.programmar.Scala.Terminals.Scala_Punctuation('!');
		public Scala_Punctuation notOperator = new Scala_Punctuation('!');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
