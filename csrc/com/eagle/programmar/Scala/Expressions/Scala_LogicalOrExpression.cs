...
namespace com.eagle.programmar.Scala.Expressions
{
	...
	public class Scala_LogicalOrExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Scala.Terminals.Scala_Punctuation orOperator = new com.eagle.programmar.Scala.Terminals.Scala_Punctuation("||");
		public Scala_Punctuation orOperator = new Scala_Punctuation("||");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
