...
namespace com.eagle.programmar.AWK.Functions
{
	...
	public class AWK_IntFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.AWK.Terminals.AWK_Keyword INT = new com.eagle.programmar.AWK.Terminals.AWK_Keyword("int");
		public AWK_Keyword INT = new AWK_Keyword("int");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
