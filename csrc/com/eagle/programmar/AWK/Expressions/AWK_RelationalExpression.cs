...
namespace com.eagle.programmar.AWK.Expressions
{
	...
	public class AWK_RelationalExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: private @SKIP Operator2Metrics _metrics = null;
		...
		public override void interpret(EagleInterpreter interpreter)
		{
			...
			throw new Exception("Unexpected relational operator: " + leftValue + " " + oper + " " + rightValue);
		}
