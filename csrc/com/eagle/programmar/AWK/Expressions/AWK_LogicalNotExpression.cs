...
namespace com.eagle.programmar.AWK.Expressions
{
	...
	public class AWK_LogicalNotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.AWK.Terminals.AWK_Punctuation operator = new com.eagle.programmar.AWK.Terminals.AWK_Punctuation('!');
