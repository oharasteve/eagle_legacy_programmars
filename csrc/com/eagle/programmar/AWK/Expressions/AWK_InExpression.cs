...
namespace com.eagle.programmar.AWK.Expressions
{
	...
	public class AWK_InExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.AWK.Terminals.AWK_Keyword IN = new com.eagle.programmar.AWK.Terminals.AWK_Keyword("in");
