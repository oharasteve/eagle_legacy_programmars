...
namespace com.eagle.programmar.Natural
{
	...
	{
		public static readonly string[] RESERVED_WORDS = new string[] {"AND", "BUT", "BY", "COUPLED", "DOEND", "ELSE", "END", "ENDING", "END-BREAK", "END-ENDDATA", "END-ENDPAGE", "END-FIND", "END-HISTOGRAM", "END-IF", "END-NOREC", "END-READ", "END-REPEAT", "END-SORT", "END-START", "FIND", "FROM", "HORIZ", "INTO", "IS", "LEFT", "NOT", "OR", "READ", "REDEFINE", "SORTED", "STARTING", "STORE", "THRU", "TO", "TRAILER", "UNDERLINED", "USING", "VERT", "WHERE", "WITH"};
