...
namespace com.eagle.programmar.Natural.Expressions
{
	...
	public class Natural_MultiplicativeExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Natural.Terminals.Natural_PunctuationChoice timesDivide = new com.eagle.programmar.Natural.Terminals.Natural_PunctuationChoice("*", "/");
