...
namespace com.eagle.programmar.CSS.Directives
{
	...
	public class CSS_AtProvide : TokenSequence
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.CSS.Terminals.CSS_Keyword PROVIDE = new com.eagle.programmar.CSS.Terminals.CSS_Keyword("provide");
		public CSS_Keyword PROVIDE = new CSS_Keyword("provide");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
