...
namespace com.eagle.programmar.CSS.Values
{
	...
	public class CSS_RotateValue : TokenSequence
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.CSS.Terminals.CSS_Keyword ROTATE = new com.eagle.programmar.CSS.Terminals.CSS_Keyword("rotate");
		public CSS_Keyword ROTATE = new CSS_Keyword("rotate");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.tokens.punctuation.PunctuationLeftParen leftParen;
		public PunctuationLeftParen leftParen;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.CSS.Terminals.CSS_Number number;
		public CSS_Number number;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) com.eagle.programmar.CSS.Terminals.CSS_Keyword DEG = new com.eagle.programmar.CSS.Terminals.CSS_Keyword("deg");
