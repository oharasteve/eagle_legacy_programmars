...
namespace com.eagle.programmar.CSS.Terminals
{
	...
	public class CSS_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public CSS_PunctuationChoice() : base()
		{
		}

		public CSS_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
