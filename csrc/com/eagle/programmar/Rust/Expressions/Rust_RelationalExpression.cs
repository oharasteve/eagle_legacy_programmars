...
namespace com.eagle.programmar.Rust.Expressions
{
	...
	public class Rust_RelationalExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: private @SKIP Operator2Metrics _metrics = null;
		...
		public static Rust_Expression generateRelational(Operator2Metrics.Oper2Types types, Rust_Expression leftExpr, EagleGenerator.RelationalEnum relOp, Rust_Expression rightExpr, AbstractToken source)
		{
