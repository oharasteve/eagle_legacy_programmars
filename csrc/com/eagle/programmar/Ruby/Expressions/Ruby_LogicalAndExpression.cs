...
namespace com.eagle.programmar.Ruby.Expressions
{
	...
	public class Ruby_LogicalAndExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Ruby.Terminals.Ruby_Punctuation andOperator = new com.eagle.programmar.Ruby.Terminals.Ruby_Punctuation("&&");
		public Ruby_Punctuation andOperator = new Ruby_Punctuation("&&");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
