...
namespace com.eagle.programmar.Java.Functions
{
	...
	public class Java_MathAbsFunc : TokenSequence, EagleRunnable
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Java.Terminals.Java_Keyword ABS = new com.eagle.programmar.Java.Terminals.Java_Keyword("abs");
		public Java_Keyword ABS = new Java_Keyword("abs");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
