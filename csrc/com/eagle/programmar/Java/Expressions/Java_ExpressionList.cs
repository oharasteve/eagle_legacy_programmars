...
namespace com.eagle.programmar.Java.Expressions
{
	...
	public class Java_ExpressionList : PrimaryOperator
	{
...
// ORIGINAL LINE: public @S(20) @OPT TokenList<com.eagle.programmar.Java.Terminals.Java_Comment> comment;
		public  OPT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) @OPT @NOSPACE Java_ArgumentList valueList;
		public  OPT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) @NOSPACE PunctuationRightBrace rightBrace;
		public  NOSPACE;
	}
