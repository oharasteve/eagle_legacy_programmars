...
namespace com.eagle.programmar.Java.Expressions
{
	...
	public class Java_BitwiseNotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Java.Terminals.Java_Punctuation logicalNotOperator = new com.eagle.programmar.Java.Terminals.Java_Punctuation('~');
		public Java_Punctuation logicalNotOperator = new Java_Punctuation('~');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Java.Java_Expression expr;
