...
namespace com.eagle.programmar.MSSolution.Terminals
{
	...
	public class MSSolution_KeywordChoice : TerminalKeywordChoice
	{
		// Need default constructor for reading from the XML file
		public MSSolution_KeywordChoice() : base()
		{
		}

		public MSSolution_KeywordChoice(params string[] words) : base(words)
		{
		}
	}
