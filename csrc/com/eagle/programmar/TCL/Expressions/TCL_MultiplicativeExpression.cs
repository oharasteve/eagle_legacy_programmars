...
namespace com.eagle.programmar.TCL.Expressions
{
	...
	public class TCL_MultiplicativeExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.TCL.Terminals.TCL_PunctuationChoice operator = new com.eagle.programmar.TCL.Terminals.TCL_PunctuationChoice("*", "/", "%");
