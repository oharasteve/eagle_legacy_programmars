...
namespace com.eagle.programmar.TCL.Terminals
{
	...
	public class TCL_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public TCL_PunctuationChoice() : base()
		{
		}

		public TCL_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
