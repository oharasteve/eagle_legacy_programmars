...
namespace com.eagle.programmar.SQL.Terminals
{
	...
	public class SQL_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public SQL_PunctuationChoice() : base()
		{
		}

		public SQL_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
