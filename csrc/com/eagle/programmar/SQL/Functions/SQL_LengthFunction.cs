...
namespace com.eagle.programmar.SQL.Functions
{
	...
	public class SQL_LengthFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.SQL.Terminals.SQL_Keyword LENGTH = new com.eagle.programmar.SQL.Terminals.SQL_Keyword("LENGTH");
		public SQL_Keyword LENGTH = new SQL_Keyword("LENGTH");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
