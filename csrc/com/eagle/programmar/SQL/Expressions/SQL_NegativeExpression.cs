...
namespace com.eagle.programmar.SQL.Expressions
{
	...
	public class SQL_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.SQL.Terminals.SQL_PunctuationChoice operator = new com.eagle.programmar.SQL.Terminals.SQL_PunctuationChoice("-", "+");
		public SQL_PunctuationChoice @operator = new SQL_PunctuationChoice("-", "+");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @NOSPACE SQL_Expression expr;
		public  NOSPACE;
