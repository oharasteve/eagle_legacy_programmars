...
namespace com.eagle.programmar.IntelASM.Terminals
{
	...
	public class IntelASM_KeywordChoice : TerminalKeywordChoice
	{
		// Need default constructor for reading from the XML file
		public IntelASM_KeywordChoice() : base()
		{
		}

		public IntelASM_KeywordChoice(params string[] words) : base(words)
		{
		}
	}
