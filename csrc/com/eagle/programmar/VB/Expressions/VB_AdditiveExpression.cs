...
namespace com.eagle.programmar.VB.Expressions
{
	...
	public class VB_AdditiveExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @DOC("operators/arithmetic-operators") com.eagle.programmar.VB.Terminals.VB_PunctuationChoice operator = new com.eagle.programmar.VB.Terminals.VB_PunctuationChoice("+", "-");
		public @DOC("operators/arithmetic-operators") VB_PunctuationChoice @operator = new VB_PunctuationChoice("+", "-");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
