...
namespace com.eagle.programmar.VB.Expressions
{
	...
	public class VB_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.VB.Terminals.VB_PunctuationChoice operator = new com.eagle.programmar.VB.Terminals.VB_PunctuationChoice("-", "+");
