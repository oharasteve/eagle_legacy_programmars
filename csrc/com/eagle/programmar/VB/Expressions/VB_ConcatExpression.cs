...
namespace com.eagle.programmar.VB.Expressions
{
	...
	public class VB_ConcatExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @DOC("operators/concatenation-operators") com.eagle.programmar.VB.Terminals.VB_Punctuation operator = new com.eagle.programmar.VB.Terminals.VB_Punctuation('&');
		public @DOC("operators/concatenation-operators") VB_Punctuation @operator = new VB_Punctuation('&');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
