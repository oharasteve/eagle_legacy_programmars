...
namespace com.eagle.programmar.VB.Expressions
{
	...
	public class VB_EqualityExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.VB.Terminals.VB_KeywordChoice operator = new com.eagle.programmar.VB.Terminals.VB_KeywordChoice("is", "like", "isnot");
		public VB_KeywordChoice @operator = new VB_KeywordChoice("is", "like", "isnot");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
