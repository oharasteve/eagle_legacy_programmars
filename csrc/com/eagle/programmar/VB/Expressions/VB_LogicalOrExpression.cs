...
namespace com.eagle.programmar.VB.Expressions
{
	...
	public class VB_LogicalOrExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @DOC("operators/logical-bitwise-operators") com.eagle.programmar.VB.Terminals.VB_KeywordChoice orOperator = new com.eagle.programmar.VB.Terminals.VB_KeywordChoice("or", "orelse");
		public @DOC("operators/logical-bitwise-operators") VB_KeywordChoice orOperator = new VB_KeywordChoice("or", "orelse");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.VB.VB_Expression right = new com.eagle.programmar.VB.VB_Expression(this, AllowedPrecedence.HIGHER);
		...
		public void interpret(EagleInterpreter interpreter)
		{
			...
			case "orelse":
				...
				return;
			default:
				throw new Exception("Unable to handle " + oper + " in VB_ConditionalOrExpression");
			}
		}
