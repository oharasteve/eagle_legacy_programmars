...
namespace com.eagle.programmar.VB.Statements
{
	...
	public class VB_Subroutine : TokenSequence, AbstractFunction, EagleRunnable, EagleScope.EagleScopeInterface, EagleTransformableFunction
	{
...
// ORIGINAL LINE: public @S(10) @OPT VB_KeywordChoice modifier = new com.eagle.programmar.VB.Terminals.VB_KeywordChoice("private", "public");
		public  OPT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @DOC("statements/sub-statement") com.eagle.programmar.VB.Terminals.VB_Keyword SUB1 = new com.eagle.programmar.VB.Terminals.VB_Keyword("sub");
		public @DOC("statements/sub-statement") VB_Keyword SUB1 = new VB_Keyword("sub");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(60) @OPT TokenList<com.eagle.programmar.VB.VB_Element> stmts;
		public @OPT TokenList<VB_Element> stmts;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(70) com.eagle.programmar.VB.Terminals.VB_Keyword END = new com.eagle.programmar.VB.Terminals.VB_Keyword("end");
		public VB_Keyword END = new VB_Keyword("end");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(80) com.eagle.programmar.VB.Terminals.VB_Keyword SUB2 = new com.eagle.programmar.VB.Terminals.VB_Keyword("sub");
...
// ORIGINAL LINE: public @SKIP ArgumentsMetrics _argumentsMetrics = null;
	...
	//		}
			...
			if (VERBOSE)
			{
				Console.WriteLine("** Found VB subroutine " + subName);
			}
