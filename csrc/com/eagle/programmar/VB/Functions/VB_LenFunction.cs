...
namespace com.eagle.programmar.VB.Functions
{
	...
	public class VB_LenFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) @DOC("functions/string-functions") com.eagle.programmar.VB.Terminals.VB_Keyword LEN = new com.eagle.programmar.VB.Terminals.VB_Keyword("LEN");
		public @DOC("functions/string-functions") VB_Keyword LEN = new VB_Keyword("LEN");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
