...
namespace com.eagle.programmar.PLI.Functions
{
	...
	public class PLI_LengthFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.PLI.Terminals.PLI_Keyword LENGTH = new com.eagle.programmar.PLI.Terminals.PLI_Keyword("LENGTH");
		public PLI_Keyword LENGTH = new PLI_Keyword("LENGTH");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
