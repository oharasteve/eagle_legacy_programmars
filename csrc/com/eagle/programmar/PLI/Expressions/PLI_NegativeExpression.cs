...
namespace com.eagle.programmar.PLI.Expressions
{
	...
	public class PLI_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.PLI.Terminals.PLI_PunctuationChoice operator = new com.eagle.programmar.PLI.Terminals.PLI_PunctuationChoice("-", "+");
