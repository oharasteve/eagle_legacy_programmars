...
namespace com.eagle.programmar.PLI.Expressions
{
	...
	public class PLI_LogicalOrExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.PLI.Terminals.PLI_PunctuationChoice orOper = new com.eagle.programmar.PLI.Terminals.PLI_PunctuationChoice("^", "|", "!");
