...
namespace com.eagle.programmar.PLI.Expressions
{
	...
	public class PLI_StrCatExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.PLI.Terminals.PLI_Punctuation operator = new com.eagle.programmar.PLI.Terminals.PLI_Punctuation("||");
		public PLI_Punctuation @operator = new PLI_Punctuation("||");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
