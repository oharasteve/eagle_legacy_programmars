...
namespace com.eagle.programmar.JavaP.Statements
{
	...
	public class JavaP_CompiledFrom : TokenSequence
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.JavaP.Terminals.JavaP_Keyword COMPILED = new com.eagle.programmar.JavaP.Terminals.JavaP_Keyword("Compiled");
		public JavaP_Keyword COMPILED = new JavaP_Keyword("Compiled");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.JavaP.Terminals.JavaP_Keyword FROM = new com.eagle.programmar.JavaP.Terminals.JavaP_Keyword("from");
