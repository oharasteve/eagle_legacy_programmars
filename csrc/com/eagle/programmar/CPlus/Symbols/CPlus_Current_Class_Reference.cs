...
namespace com.eagle.programmar.CPlus.Symbols
{
	using EagleFileReader = com.eagle.parsers.EagleFileReader;
	using C_Identifier_Reference = com.eagle.programmar.C.Symbols.C_Identifier_Reference;
	using CPlus_Class = com.eagle.programmar.CPlus.CPlus_Class;
	using AbstractToken = com.eagle.tokens.AbstractToken;

	public class CPlus_Current_Class_Reference : C_Identifier_Reference
	{
