...
namespace com.eagle.programmar.FSharp.Expressions
{
	...
	public class FSharp_VariableExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: public @S(10) com.eagle.programmar.FSharp.FSharp_Variable variable;
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			return generator.newVariableExpression(variable.id.getValue(), EagleGenerator.SubscriptEnum.FIRST_IS_ZERO, subscr, this);
		}
	}
