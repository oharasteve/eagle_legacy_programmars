...
namespace com.eagle.programmar.FSharp.Expressions
{
	...
	public class FSharp_Logical_Or_Expression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @DOC("symbol-and-operator-reference/boolean-operators") com.eagle.programmar.FSharp.Terminals.FSharp_Punctuation OR = new com.eagle.programmar.FSharp.Terminals.FSharp_Punctuation("||");
		public @DOC("symbol-and-operator-reference/boolean-operators") FSharp_Punctuation OR = new FSharp_Punctuation("||");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
