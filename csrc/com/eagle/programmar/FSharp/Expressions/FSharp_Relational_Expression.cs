...
namespace com.eagle.programmar.FSharp.Expressions
{
	...
	public class FSharp_Relational_Expression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.FSharp.Terminals.FSharp_PunctuationChoice operator = new com.eagle.programmar.FSharp.Terminals.FSharp_PunctuationChoice("=", "<>", "<=", ">=", "<", ">");
		public FSharp_PunctuationChoice @operator = new FSharp_PunctuationChoice("=", "<>", "<=", ">=", "<", ">");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
