...
namespace com.eagle.programmar.Fortran.Expressions
{
	...
	public class Fortran_StringConcatenation : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Fortran.Terminals.Fortran_Punctuation operator = new com.eagle.programmar.Fortran.Terminals.Fortran_Punctuation("//");
		public Fortran_Punctuation @operator = new Fortran_Punctuation("//");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
