...
namespace com.eagle.programmar.Fortran.Expressions
{
	...
	public class Fortran_LogicalAndExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Fortran.Terminals.Fortran_Keyword andOperator = new com.eagle.programmar.Fortran.Terminals.Fortran_Keyword(".AND.");
		public Fortran_Keyword andOperator = new Fortran_Keyword(".AND.");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
