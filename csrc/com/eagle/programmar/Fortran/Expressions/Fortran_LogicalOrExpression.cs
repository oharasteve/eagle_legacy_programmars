...
namespace com.eagle.programmar.Fortran.Expressions
{
	...
	public class Fortran_LogicalOrExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Fortran.Terminals.Fortran_Keyword orOperator = new com.eagle.programmar.Fortran.Terminals.Fortran_Keyword(".OR.");
		public Fortran_Keyword orOperator = new Fortran_Keyword(".OR.");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
