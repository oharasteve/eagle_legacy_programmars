...
namespace com.eagle.programmar.Fortran.Expressions
{
	...
	public class Fortran_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Fortran.Terminals.Fortran_PunctuationChoice operator = new com.eagle.programmar.Fortran.Terminals.Fortran_PunctuationChoice("-");
		public Fortran_PunctuationChoice @operator = new Fortran_PunctuationChoice("-");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Fortran.Fortran_Expression expr;
