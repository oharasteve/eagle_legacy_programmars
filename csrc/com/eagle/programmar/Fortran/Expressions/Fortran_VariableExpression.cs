...
namespace com.eagle.programmar.Fortran.Expressions
{
	...
	public class Fortran_VariableExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Fortran.Fortran_Variable variable;
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			return generator.newVariableExpression(variable.var.getValue(), EagleGenerator.SubscriptEnum.FIRST_IS_ONE, subscrExpr, this);
		}
	}
}
