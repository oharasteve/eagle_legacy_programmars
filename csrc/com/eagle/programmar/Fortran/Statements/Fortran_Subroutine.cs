...
namespace com.eagle.programmar.Fortran.Statements
{
	...
	public class Fortran_Subroutine : TokenSequence, AbstractFunction, EagleRunnable, EagleScope.EagleScopeInterface, EagleTransformableFunction
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) @DOC("6j4m0vnbg/index.html") com.eagle.programmar.Fortran.Terminals.Fortran_Keyword SUBROUTINE1 = new com.eagle.programmar.Fortran.Terminals.Fortran_Keyword("SUBROUTINE");
		public @DOC("6j4m0vnbg/index.html") Fortran_Keyword SUBROUTINE1 = new Fortran_Keyword("SUBROUTINE");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) @OPT SeparatedList<com.eagle.programmar.Fortran.Symbols.Fortran_Variable_Reference, com.eagle.tokens.punctuation.PunctuationComma> parameters;
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(90) com.eagle.programmar.Fortran.Terminals.Fortran_Keyword SUBROUTINE2 = new com.eagle.programmar.Fortran.Terminals.Fortran_Keyword("SUBROUTINE");
		public Fortran_Keyword SUBROUTINE2 = new Fortran_Keyword("SUBROUTINE");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(100) com.eagle.programmar.Fortran.Symbols.Fortran_Function_Reference subName2;
		public Fortran_Function_Reference subName2;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(110) com.eagle.programmar.Fortran.Terminals.Fortran_EOLN eoln2;
...
// ORIGINAL LINE: private @SKIP EagleScope _scope = new com.eagle.scope.EagleScope(this, com.eagle.programmar.Fortran.Fortran_Syntax.IS_CASE_SENSITIVE);
		...
		public void transformFunction(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			if (VERBOSE)
			{
				Console.WriteLine("** Found Fortran subroutine " + fnName);
			}
