...
namespace com.eagle.programmar.Gupta.Statements
{
	...
	public class Gupta_Comment_Statement : TokenSequence
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Gupta.Terminals.Gupta_Punctuation exclamation = new com.eagle.programmar.Gupta.Terminals.Gupta_Punctuation('!');
