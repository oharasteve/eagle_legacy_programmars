...
namespace com.eagle.programmar.Gupta.Terminals
{
	...
	public class Gupta_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public Gupta_PunctuationChoice() : base()
		{
		}

		public Gupta_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
