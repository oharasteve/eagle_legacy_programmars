...
namespace com.eagle.programmar.Perl.Statements
{
	...
	public class Perl_ChompCommand : TokenSequence, AbstractStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Perl.Terminals.Perl_Keyword CHOMP = new com.eagle.programmar.Perl.Terminals.Perl_Keyword("chomp");
		public Perl_Keyword CHOMP = new Perl_Keyword("chomp");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
