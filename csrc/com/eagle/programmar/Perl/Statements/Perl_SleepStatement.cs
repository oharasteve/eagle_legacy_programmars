...
namespace com.eagle.programmar.Perl.Statements
{
	...
	public class Perl_SleepStatement : TokenSequence, AbstractStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Perl.Terminals.Perl_Keyword SLEEP = new com.eagle.programmar.Perl.Terminals.Perl_Keyword("sleep");
