...
namespace com.eagle.programmar.Perl.Expressions
{
	...
	public class Perl_BitwiseExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Perl.Perl_Expression right = new com.eagle.programmar.Perl.Perl_Expression(this, AllowedPrecedence.HIGHER);
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			{
			case "&":
				return generator.newBitwiseExpression(leftExpr, EagleGenerator.BitwiseEnum.AND, rightExpr, this);
			case "|":
				return generator.newBitwiseExpression(leftExpr, EagleGenerator.BitwiseEnum.OR, rightExpr, this);
			case "^":
				return generator.newBitwiseExpression(leftExpr, EagleGenerator.BitwiseEnum.XOR, rightExpr, this);
			default:
				throw new Exception("Unexpected operator: " + @operator);
			}
		}
