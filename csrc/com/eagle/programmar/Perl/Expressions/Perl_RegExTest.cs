...
namespace com.eagle.programmar.Perl.Expressions
{
	...
	using Perl_Regular_Expression = com.eagle.programmar.Perl.Terminals.Perl_Regular_Expression;
	using PrecedenceOperator = com.eagle.tokens.PrecedenceOperator;

	public class Perl_RegExTest : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Perl.Terminals.Perl_Regular_Expression expr;
		public Perl_Regular_Expression expr;
	}
