...
namespace com.eagle.programmar.Basic.Functions
{
	...
	public class Basic_ChrFunction : PrimaryOperator, EagleRunnable
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Basic.Terminals.Basic_Keyword CHR = new com.eagle.programmar.Basic.Terminals.Basic_Keyword("CHR$");
		public Basic_Keyword CHR = new Basic_Keyword("CHR$");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// ORIGINAL LINE: public @S(40) com.eagle.tokens.punctuation.PunctuationRightParen rightParen;
		...
		public override void interpret(EagleInterpreter interpreter)
		{
			...
			interpreter.pushStr(Convert.ToString(x));
		}
	}
