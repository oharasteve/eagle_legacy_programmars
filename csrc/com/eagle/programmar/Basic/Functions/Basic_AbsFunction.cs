...
namespace com.eagle.programmar.Basic.Functions
{
	...
	public class Basic_AbsFunction : PrimaryOperator, EagleRunnable
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Basic.Terminals.Basic_Keyword ABS = new com.eagle.programmar.Basic.Terminals.Basic_Keyword("ABS");
		public Basic_Keyword ABS = new Basic_Keyword("ABS");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
