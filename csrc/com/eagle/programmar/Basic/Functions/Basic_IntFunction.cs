...
namespace com.eagle.programmar.Basic.Functions
{
	...
	public class Basic_IntFunction : PrimaryOperator, EagleRunnable
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Basic.Terminals.Basic_Keyword INT = new com.eagle.programmar.Basic.Terminals.Basic_Keyword("INT");
		public Basic_Keyword INT = new Basic_Keyword("INT");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
