...
namespace com.eagle.programmar.Rexx.Functions
{
	...
	public class Rexx_LengthFunction : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Rexx.Terminals.Rexx_Keyword LENGTH = new com.eagle.programmar.Rexx.Terminals.Rexx_Keyword("LENGTH");
		public Rexx_Keyword LENGTH = new Rexx_Keyword("LENGTH");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
