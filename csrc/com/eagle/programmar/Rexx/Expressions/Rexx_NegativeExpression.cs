...
namespace com.eagle.programmar.Rexx.Expressions
{
	...
	public class Rexx_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Rexx.Terminals.Rexx_PunctuationChoice operator = new com.eagle.programmar.Rexx.Terminals.Rexx_PunctuationChoice("-", "+");
