...
namespace com.eagle.programmar.Rexx.Expressions
{
	...
	public class Rexx_LogicalNotExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Rexx.Terminals.Rexx_Punctuation NOT = new com.eagle.programmar.Rexx.Terminals.Rexx_Punctuation('\\');
		public Rexx_Punctuation NOT = new Rexx_Punctuation('\\');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
