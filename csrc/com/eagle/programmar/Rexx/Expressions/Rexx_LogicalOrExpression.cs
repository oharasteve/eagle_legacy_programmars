...
namespace com.eagle.programmar.Rexx.Expressions
{
	...
	public class Rexx_LogicalOrExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Rexx.Terminals.Rexx_Punctuation OR = new com.eagle.programmar.Rexx.Terminals.Rexx_Punctuation('|');
		public Rexx_Punctuation OR = new Rexx_Punctuation('|');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
