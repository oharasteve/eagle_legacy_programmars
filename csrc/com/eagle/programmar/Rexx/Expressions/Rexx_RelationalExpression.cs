...
namespace com.eagle.programmar.Rexx.Expressions
{
	...
	public class Rexx_RelationalExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Rexx.Terminals.Rexx_PunctuationChoice operator = new com.eagle.programmar.Rexx.Terminals.Rexx_PunctuationChoice("=", "<=", ">=", "\\=", "<", ">");
		public Rexx_PunctuationChoice @operator = new Rexx_PunctuationChoice("=", "<=", ">=", "\\=", "<", ">");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
