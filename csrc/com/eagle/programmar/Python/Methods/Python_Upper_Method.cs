...
namespace com.eagle.programmar.Python.Methods
{
	...
	public class Python_Upper_Method : PrecedenceOperator, EagleRunnable
	{
...
// ORIGINAL LINE: public @S(20) @NOSPACE PunctuationPeriod dot;
		public  NOSPACE;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) @NOSPACE Python_KeywordChoice UPPER = new com.eagle.programmar.Python.Terminals.Python_KeywordChoice("lower", "upper");
		public  NOSPACE;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
