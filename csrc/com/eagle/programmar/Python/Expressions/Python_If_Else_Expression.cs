...
namespace com.eagle.programmar.Python.Expressions
{
	...
	public class Python_If_Else_Expression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) com.eagle.programmar.Python.Terminals.Python_Keyword ELSE = new com.eagle.programmar.Python.Terminals.Python_Keyword("else");
		public Python_Keyword ELSE = new Python_Keyword("else");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(50) com.eagle.programmar.Python.Python_Expression right = new com.eagle.programmar.Python.Python_Expression(this, AllowedPrecedence.HIGHER);
