...
namespace com.eagle.programmar.Python.Expressions
{
	...
	public class Python_Negative_Expression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Python.Terminals.Python_PunctuationChoice operator = new com.eagle.programmar.Python.Terminals.Python_PunctuationChoice("*", "-", "+", "~");
...
// ORIGINAL LINE: private @SKIP Operator1Metrics _metrics = null;
		...
		public static Python_Expression generateNegative(EagleGenerator.NegativeEnum sign, Python_Expression theExpr, AbstractToken source)
		{
