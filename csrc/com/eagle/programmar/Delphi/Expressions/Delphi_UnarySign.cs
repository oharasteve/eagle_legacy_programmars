...
namespace com.eagle.programmar.Delphi.Expressions
{
	...
	public class Delphi_UnarySign : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Delphi.Terminals.Delphi_PunctuationChoice operator = new com.eagle.programmar.Delphi.Terminals.Delphi_PunctuationChoice("-", "+");
