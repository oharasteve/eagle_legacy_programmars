...
namespace com.eagle.programmar.Delphi.Terminals
{
	...
	public class Delphi_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public Delphi_PunctuationChoice() : base()
		{
		}

		public Delphi_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
