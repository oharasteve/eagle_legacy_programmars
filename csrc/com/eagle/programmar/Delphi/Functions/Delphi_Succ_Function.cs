...
namespace com.eagle.programmar.Delphi.Functions
{
	...
	public class Delphi_Succ_Function : PrimaryOperator, EagleRunnable
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Delphi.Terminals.Delphi_Keyword SUCC = new com.eagle.programmar.Delphi.Terminals.Delphi_Keyword("Succ");
		public Delphi_Keyword SUCC = new Delphi_Keyword("Succ");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
