...
namespace com.eagle.programmar.Delphi.Functions
{
	...
	public class Delphi_Length_Function : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Delphi.Terminals.Delphi_Keyword LENGTH = new com.eagle.programmar.Delphi.Terminals.Delphi_Keyword("Length");
		public Delphi_Keyword LENGTH = new Delphi_Keyword("Length");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
