...
namespace com.eagle.programmar.Julia.Expressions
{
	...
	public class Julia_MultiplicativeExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Julia.Terminals.Julia_PunctuationChoice operator = new com.eagle.programmar.Julia.Terminals.Julia_PunctuationChoice("*", "/", "%");
