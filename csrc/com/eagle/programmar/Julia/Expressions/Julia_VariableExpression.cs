...
namespace com.eagle.programmar.Julia.Expressions
{
	...
	public class Julia_VariableExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
...
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Julia.Julia_Variable variable;
		...
		public override AbstractExpression transformExpression(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			return generator.newVariableExpression(variable.vars.first().getValue(), EagleGenerator.SubscriptEnum.FIRST_IS_ONE, subscrExpr, this);
		}
	}
