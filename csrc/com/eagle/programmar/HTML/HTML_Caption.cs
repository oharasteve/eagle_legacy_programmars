...
namespace com.eagle.programmar.HTML
{
	...
	public class HTML_Caption : TokenSequence
	{
...
// ORIGINAL LINE: public @S(10) @INDENT HTML_Punctuation startTag = new com.eagle.programmar.HTML.Terminals.HTML_Punctuation('<');
		public  INDENT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) @NOSPACE HTML_Keyword CAPTION = new com.eagle.programmar.HTML.Terminals.HTML_Keyword("caption");
		public  NOSPACE;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// ORIGINAL LINE: public @S(50) @OPT TokenList<com.eagle.programmar.HTML.HTML_Program.HTML_Element> elements;
		public  OPT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(60) @OUTDENT HTML_EndCaption endCaption;
		public  OUTDENT;

		public class HTML_EndCaption : TokenSequence
		{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
