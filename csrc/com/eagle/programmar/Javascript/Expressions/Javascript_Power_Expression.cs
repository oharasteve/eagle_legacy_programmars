...
namespace com.eagle.programmar.Javascript.Expressions
{
	...
	public class Javascript_Power_Expression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Javascript.Terminals.Javascript_Punctuation stars = new com.eagle.programmar.Javascript.Terminals.Javascript_Punctuation("**");
		public Javascript_Punctuation stars = new Javascript_Punctuation("**");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Javascript.Javascript_Expression right = new com.eagle.programmar.Javascript.Javascript_Expression(this, AllowedPrecedence.ATLEAST);
