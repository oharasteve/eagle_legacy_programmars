...
namespace com.eagle.programmar.Javascript.Expressions
{
	...
	public class Javascript_DeleteExpression : PrimaryOperator
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Javascript.Terminals.Javascript_Keyword DELETE = new com.eagle.programmar.Javascript.Terminals.Javascript_Keyword("delete");
