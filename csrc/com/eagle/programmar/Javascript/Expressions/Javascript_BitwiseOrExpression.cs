...
namespace com.eagle.programmar.Javascript.Expressions
{
	...
	public class Javascript_BitwiseOrExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Javascript.Terminals.Javascript_Punctuation bitwiseOrOperator = new com.eagle.programmar.Javascript.Terminals.Javascript_Punctuation('|');
