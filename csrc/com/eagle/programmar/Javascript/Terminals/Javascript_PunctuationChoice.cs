...
namespace com.eagle.programmar.Javascript.Terminals
{
	...
	public class Javascript_PunctuationChoice : TerminalPunctuationChoice
	{
		// Need default constructor for reading from the XML file
		public Javascript_PunctuationChoice() : base()
		{
		}

		public Javascript_PunctuationChoice(params string[] puncts) : base(puncts)
		{
		}
	}
}
