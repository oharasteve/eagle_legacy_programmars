...
namespace com.eagle.programmar.Javascript.Terminals
{
	...
	public class Javascript_KeywordChoice : TerminalKeywordChoice
	{
		// Need default constructor for reading from the XML file
		public Javascript_KeywordChoice() : base()
		{
		}

		public Javascript_KeywordChoice(params string[] words) : base(words)
		{
		}
	}
