...
namespace com.eagle.programmar.Javascript.Functions
{
	...
	public class Javascript_MathFloor : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Javascript.Terminals.Javascript_Keyword MATH = new com.eagle.programmar.Javascript.Terminals.Javascript_Keyword("Math");
		public Javascript_Keyword MATH = new Javascript_Keyword("Math");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.tokens.punctuation.PunctuationPeriod dot;
		public PunctuationPeriod dot;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Javascript.Terminals.Javascript_Keyword FLOOR = new com.eagle.programmar.Javascript.Terminals.Javascript_Keyword("floor");
		public Javascript_Keyword FLOOR = new Javascript_Keyword("floor");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
