...
namespace com.eagle.programmar.Eaglish.Statements
{
	...
	public class Eaglish_String_Data : TokenSequence, EagleRunnable, AbstractStatement, EagleTransformableStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword STRING = new com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword("STRING");
		public Eaglish_Keyword STRING = new Eaglish_Keyword("STRING");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) @OPT Eaglish_String_InitialValue init;
		public  OPT;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) com.eagle.programmar.Eaglish.Terminals.Eaglish_EndOfLine eoln;
		public Eaglish_EndOfLine eoln;

		public class Eaglish_String_InitialValue : TokenSequence
		{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Eaglish.Eaglish_Expression expression;
		...
		{
			AbstractType newType = generator.transformType(EagleGenerator.TypeEnum.STRING, null, STRING);
