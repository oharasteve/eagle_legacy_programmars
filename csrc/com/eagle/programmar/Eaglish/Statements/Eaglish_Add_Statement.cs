...
namespace com.eagle.programmar.Eaglish.Statements
{
	...
	public class Eaglish_Add_Statement : TokenSequence, EagleRunnable, AbstractStatement, EagleTransformableStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword ADD = new com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword("ADD");
		public Eaglish_Keyword ADD = new Eaglish_Keyword("ADD");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Eaglish.Eaglish_Expression expr;
		public Eaglish_Expression expr;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword TO = new com.eagle.programmar.Eaglish.Terminals.Eaglish_Keyword("TO");
		public Eaglish_Keyword TO = new Eaglish_Keyword("TO");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
// ORIGINAL LINE: public @S(50) com.eagle.programmar.Eaglish.Terminals.Eaglish_EndOfLine eoln;
		...
		public override AbstractStatement transformStatement(EagleTransformer transformer, EagleGenerator<AbstractStatement, AbstractExpression, AbstractVariable, AbstractType> generator)
		{
			...
			if (!(which is Eaglish_Identifier_Reference))
			{
				throw new Exception("Can only add to variables");
			}
			Eaglish_Identifier_Reference id = (Eaglish_Identifier_Reference) which;

			AbstractExpression subscr = null;
			AbstractExpression asgExpr = generator.newAssignmentExpression(id.getValue(), EagleGenerator.SubscriptEnum.FIRST_IS_ZERO, subscr, EagleGenerator.AssignmentEnum.PLUS_EQUALS, value, this);
