...
namespace com.eagle.programmar.Eaglish.Expressions
{
	...
	public class Eaglish_AdditiveExpression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Eaglish.Terminals.Eaglish_PunctuationChoice operator = new com.eagle.programmar.Eaglish.Terminals.Eaglish_PunctuationChoice("+", "-");
		public Eaglish_PunctuationChoice @operator = new Eaglish_PunctuationChoice("+", "-");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
