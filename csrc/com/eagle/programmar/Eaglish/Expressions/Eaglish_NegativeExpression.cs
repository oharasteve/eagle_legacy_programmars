...
namespace com.eagle.programmar.Eaglish.Expressions
{
	...
	public class Eaglish_NegativeExpression : PrimaryOperator, EagleRunnable, EagleTransformableExpression
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Eaglish.Terminals.Eaglish_PunctuationChoice operator = new com.eagle.programmar.Eaglish.Terminals.Eaglish_PunctuationChoice("-", "+");
