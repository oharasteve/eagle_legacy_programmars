...
namespace com.eagle.programmar.Bash.Expressions
{
	...
	public class Bash_LogicalAnd_Expression : PrecedenceOperator, EagleRunnable, EagleTransformableExpression
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Bash.Terminals.Bash_Punctuation operator = new com.eagle.programmar.Bash.Terminals.Bash_Punctuation("&&");
		public Bash_Punctuation @operator = new Bash_Punctuation("&&");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
