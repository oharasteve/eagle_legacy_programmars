...
namespace com.eagle.programmar.Bash.Conditions
{
	...
	public class Bash_NotCondition : PrimaryOperator
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Bash.Terminals.Bash_Punctuation NOT = new com.eagle.programmar.Bash.Terminals.Bash_Punctuation("!");
		public Bash_Punctuation NOT = new Bash_Punctuation("!");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
