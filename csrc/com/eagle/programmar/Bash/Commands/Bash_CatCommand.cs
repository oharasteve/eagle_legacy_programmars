...
namespace com.eagle.programmar.Bash.Commands
{
	...
	public class Bash_CatCommand : TokenSequence, AbstractStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Bash.Terminals.Bash_Keyword CAT = new com.eagle.programmar.Bash.Terminals.Bash_Keyword("cat");
		public Bash_Keyword CAT = new Bash_Keyword("cat");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
