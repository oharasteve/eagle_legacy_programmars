...
namespace com.eagle.programmar.CMacro.Expressions
{
	...
	public class CMacro_SignedExpression : PrimaryOperator
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.CMacro.Terminals.CMacro_PunctuationChoice signedOperator = new com.eagle.programmar.CMacro.Terminals.CMacro_PunctuationChoice("+", "-");
		public CMacro_PunctuationChoice signedOperator = new CMacro_PunctuationChoice("+", "-");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
