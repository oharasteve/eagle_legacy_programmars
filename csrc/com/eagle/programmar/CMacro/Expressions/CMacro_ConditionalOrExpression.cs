...
namespace com.eagle.programmar.CMacro.Expressions
{
	...
	public class CMacro_ConditionalOrExpression : PrecedenceOperator, EagleRunnable
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation orOperator = new com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation("||");
		public CMacro_Punctuation orOperator = new CMacro_Punctuation("||");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
