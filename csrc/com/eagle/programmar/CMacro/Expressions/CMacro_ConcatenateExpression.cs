...
namespace com.eagle.programmar.CMacro.Expressions
{
	...
	public class CMacro_ConcatenateExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation poundOperator = new com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation("##");
