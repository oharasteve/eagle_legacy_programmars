...
namespace com.eagle.programmar.CMacro.Expressions
{
	...
	public class CMacro_BitwiseOrExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation bitwiseOrOperator = new com.eagle.programmar.CMacro.Terminals.CMacro_Punctuation('|');
		public CMacro_Punctuation bitwiseOrOperator = new CMacro_Punctuation('|');
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
