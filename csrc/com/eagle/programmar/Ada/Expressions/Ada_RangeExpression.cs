...
namespace com.eagle.programmar.Ada.Expressions
{
	...
	public class Ada_RangeExpression : PrecedenceOperator
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Ada.Terminals.Ada_Punctuation dotDot = new com.eagle.programmar.Ada.Terminals.Ada_Punctuation("..");
		public Ada_Punctuation dotDot = new Ada_Punctuation("..");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
