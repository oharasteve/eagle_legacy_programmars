...
namespace com.eagle.programmar.Ada.Statements
{
	...
	public class Ada_WhileStatement : TokenSequence, EagleRunnableWithResult, AbstractStatement, EagleTransformableStatement
	{
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(10) com.eagle.programmar.Ada.Terminals.Ada_Keyword WHILE = new com.eagle.programmar.Ada.Terminals.Ada_Keyword("while");
		public Ada_Keyword WHILE = new Ada_Keyword("while");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Ada.Ada_Expression condition;
		public Ada_Expression condition;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(30) com.eagle.programmar.Ada.Terminals.Ada_Keyword LOOP = new com.eagle.programmar.Ada.Terminals.Ada_Keyword("loop");
		public Ada_Keyword LOOP = new Ada_Keyword("loop");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(40) com.eagle.tokens.TokenList<com.eagle.programmar.Ada.Ada_Statement> statements;
		public TokenList<Ada_Statement> statements;
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(50) com.eagle.programmar.Ada.Terminals.Ada_Keyword END = new com.eagle.programmar.Ada.Terminals.Ada_Keyword("end");
		public Ada_Keyword END = new Ada_Keyword("end");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(60) com.eagle.programmar.Ada.Terminals.Ada_Keyword LOOP2 = new com.eagle.programmar.Ada.Terminals.Ada_Keyword("loop");
