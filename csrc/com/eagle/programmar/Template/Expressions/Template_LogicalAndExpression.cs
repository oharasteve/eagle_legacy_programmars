...
namespace com.eagle.programmar.Template.Expressions
{
	...
	public class Template_LogicalAndExpression : PrecedenceOperator, EagleRunnable
	{
...
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
// ORIGINAL LINE: public @S(20) com.eagle.programmar.Template.Terminals.Template_Keyword AND = new com.eagle.programmar.Template.Terminals.Template_Keyword("and");
		public Template_Keyword AND = new Template_Keyword("and");
// JAVA TO C# CONVERTER TASK: Most Java annotations will not have direct .NET equivalent attributes:
